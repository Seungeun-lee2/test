					...
					<div class="card-body">
						<form role="form" method="post" action="modify.do" name="modifyForm">
							...
							<div class="form-group">
								...
								<input type=n"text" id="title" name='title' value="${notice.title }" class="form-control" >
							</div>
							<div class="form-group">
								<label for="writer">작성자</label> 
								<input type="text" id="writer" value="${notice.writer }" readonly	name="writer" class="form-control" >
							</div>
							<div class="form-group">
