				...
				<div class="card card-outline card-primary">
						...
						<div class="col-sm-12 row">
							...
							<div class="form-group col-sm-4">
								<label for="regDate">작성일</label> <input type="text"
									...
									value="<fmt:formatDate value="${pds.regDate }" pattern="yyyy-MM-dd" />"
									readonly />
							</div>
							<div class="form-group col-sm-4">
											...
											<div class="col-md-4 col-sm-4 col-xs-12"
												...
												<div class="info-box">
													...
													<div class="info-box-content">
														...
														</span> <span class="info-box-number">${attach.fileName }</span>
													</div>
												</div>
											</div>
										</c:forEach>
					...
					<div class="card-footer">
						...
						<button type="button" id="modifyBtn" class="btn btn-warning"
							onclick="submit_go('modifyForm.do','${pds.pno}');">Modify</button>
						<button type="button" id="removeBtn" class="btn btn-danger"
							onclick="submit_go('remove.do','${pds.pno}');">REMOVE</button>
