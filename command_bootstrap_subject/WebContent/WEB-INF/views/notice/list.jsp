   	...
   	<section class="content">
   		<div class="card">
   			<div class="card-header with-border">
   				<button type="button" class="btn btn-primary" onclick="OpenWindow('registForm.do','공지등록',1000,900);" >공지등록</button>
   				<div id="keyword" class="card-tools" style="width:550px;">
   					 <div class="input-group row">
					 	...
					 	<select class="form-control col-md-3" name="searchType" id="searchType">
							...
							<option value="t"  ${cri.searchType eq 't' ? 'selected':''}>글제목</option>
							<option value="w"  ${cri.searchType eq 'w' ? 'selected':''}>작성자</option>
							<option value="c"  ${cri.searchType eq 'c' ? 'selected':''}>글내용</option>
						</select>
						<!-- keyword -->
